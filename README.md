...
На данный момент реализована структура проекта: подключен Docker, Docker Compose, PostgreSQL, NGINX для статики и ряд других мелких функций. А также приложение для аутентификации пользователя и CI пайплайн для анализа кода на соответствие стандарту PEP8.
Планируется реализация приложения для работы с услугами.