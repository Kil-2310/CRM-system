...
На данный момент реализована структура проекта: подключен Docker, Docker Compose, PostgreSQL, NGINX для статики и ряд других мелких функций.
Планируется реализация аутентификация пользователя через сессии и настрою CI пайплайн для соответствия стандарту PEP8. 