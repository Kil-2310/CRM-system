...
В системе множество ролей, под каждую свой интерфейс. У всех пользователей, кроме администратора, пароль 123123Qq:
    ...
    1. Менеджер. Username - Bob
    2. Оператор. Username - Tom
...
На данный момент реализовано:
    ...
    2. Приложения: аутентификация, продукты, лиды (потенциальные покупатели)

Планируется разработка приложения по работе с контрактами.